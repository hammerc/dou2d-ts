...
(function (dou2d) {
     ...
     * 渲染上下文
     */
    dou2d.glContext = "glContext";
    /**
     * 是否预乘 Alpha
     */
    dou2d.UNPACK_PREMULTIPLY_ALPHA_WEBGL = "UNPACK_PREMULTIPLY_ALPHA_WEBGL";
    /**
     * 引擎默认空白贴图
     */
    dou2d.engine_default_empty_texture = "engine_default_empty_texture";
    /**
     * 是否抗锯齿
     */
    dou2d.SMOOTHING = "smoothing";
})(dou2d || (dou2d = {}));
(function () {
...
(function (dou2d) {
    ...
    dou2d.markCannotUse = markCannotUse;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
     ...
     */
    dou2d.textureScaleFactor = 1;
    /**
     * 是否派发 Event.RENDER 事件
     */
    dou2d.invalidateRenderFlag = false;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
...
(function (dou2d) {
    ...
    class Ticker extends dou.TickerBase {
        ...
        updateLogic(passedTime) {
            ...
            let drawCalls = dou2d.player.render(passedTime);
            renderCost = dou.getTimer() - renderCost;
            this.broadcastEnterFrame();
            logicCost = dou.getTimer() - logicCost - renderCost;
            dou2d.stat.onFrame(logicCost, renderCost, drawCalls);
        }
        broadcastDelay(passedTime) {
            dou2d.$updateCallLater();
            dou2d.$updateInterval(passedTime);
            dou2d.$updateTimeout(passedTime);
        }
        ...
        broadcastRender() {
            if (dou2d.invalidateRenderFlag) {
                dou2d.invalidateRenderFlag = false;
                if (dou2d.renderCallBackList.length > 0) {
                    let list = dou2d.renderCallBackList.concat();
                    for (let display of list) {
                        display.dispatchEvent(dou2d.Event2D.RENDER);
                    }
                }
                if (dou2d.renderOnceCallBackList.length > 0) {
                    let list = dou2d.renderOnceCallBackList;
                    dou2d.renderOnceCallBackList = [];
                    for (let display of list) {
                        display.dispatchEvent(dou2d.Event2D.RENDER);
                    }
                }
        ...
        broadcastEnterFrame() {
            if (dou2d.enterFrameCallBackList.length > 0) {
                let list = dou2d.enterFrameCallBackList.concat();
                for (let display of list) {
                    display.dispatchEvent(dou2d.Event2D.ENTER_FRAME);
                }
            }
            if (dou2d.enterFrameOnceCallBackList.length > 0) {
                let list = dou2d.enterFrameOnceCallBackList;
                dou2d.enterFrameOnceCallBackList = [];
                for (let display of list) {
                    display.dispatchEvent(dou2d.Event2D.ENTER_FRAME);
                }
            }
...
(function (dou2d) {
    ...
    class Player {
        ...
        createDisplayList(stage, buffer) {
            let displayList = new dou2d.DisplayList(stage);
...
var dou2d;
(function (dou2d) {
    dou2d.enterFrameCallBackList = [];
    dou2d.enterFrameOnceCallBackList = [];
    dou2d.renderCallBackList = [];
    dou2d.renderOnceCallBackList = [];
    ...
    class DisplayObject extends dou.EventDispatcher {
        ...
        $setHasDisplayList(value) {
            ...
            if (value) {
                let displayList = dou2d.DisplayList.create(this);
                if (displayList) {
        ...
        hitTestPoint(x, y, shapeFlag) {
            if (!shapeFlag) {
                ...
                if (displayList) {
                    ...
                    let buffer = dou2d.hitTestBuffer;
                    buffer.resize(3, 3);
                    let matrix = dou.recyclable(dou2d.Matrix);
                    matrix.translate(1 - localX, 1 - localY);
                    dou2d.renderer.render(this, buffer, matrix);
                    matrix.recycle();
                    try {
        ...
        addEventListener(type, listener, thisObj, once) {
            ...
            if (type == dou2d.Event2D.ENTER_FRAME || type == dou2d.Event2D.RENDER) {
                ...
                if (type == dou2d.Event2D.ENTER_FRAME) {
                    list = once ? dou2d.enterFrameOnceCallBackList : dou2d.enterFrameCallBackList;
                }
                else {
                    list = once ? dou2d.renderOnceCallBackList : dou2d.renderCallBackList;
                }
        ...
        off(type, listener, thisObj) {
            ...
            if (type == dou2d.Event2D.ENTER_FRAME || type == dou2d.Event2D.RENDER) {
                ...
                let listOnce;
                if (type == dou2d.Event2D.ENTER_FRAME) {
                    list = dou2d.enterFrameCallBackList;
                    listOnce = dou2d.enterFrameOnceCallBackList;
                }
                else {
                    list = dou2d.renderCallBackList;
                    listOnce = dou2d.renderOnceCallBackList;
                }
                list.remove(this);
...
(function (dou2d) {
    ...
    class Stage extends dou2d.DisplayObjectContainer {
         ...
         */
        set frameRate(value) {
            dou2d.ticker.frameRate = value;
        }
        get frameRate() {
            return dou2d.ticker.frameRate;
        }
        /**
         * 舞台的当前宽度
         */
        ...
        set textureScaleFactor(value) {
            dou2d.textureScaleFactor = value;
        }
        get textureScaleFactor() {
            return dou2d.textureScaleFactor;
        }
        /**
         * 屏幕可以同时触摸的数量
         */
         ...
         */
        invalidate() {
            dou2d.invalidateRenderFlag = true;
        }
    }
    dou2d.Stage = Stage;
    dou2d.markCannotUse(Stage, "alpha", 1);
    dou2d.markCannotUse(Stage, "visible", true);
    dou2d.markCannotUse(Stage, "x", 0);
    dou2d.markCannotUse(Stage, "y", 0);
    dou2d.markCannotUse(Stage, "scaleX", 1);
    dou2d.markCannotUse(Stage, "scaleY", 1);
    dou2d.markCannotUse(Stage, "rotation", 0);
    dou2d.markCannotUse(Stage, "cacheAsBitmap", false);
    dou2d.markCannotUse(Stage, "scrollRect", null);
    dou2d.markCannotUse(Stage, "filters", null);
    dou2d.markCannotUse(Stage, "blendMode", null);
    dou2d.markCannotUse(Stage, "touchEnabled", true);
    dou2d.markCannotUse(Stage, "matrix", null);
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
...
(function (dou2d) {
    ...
    class Bitmap extends dou2d.DisplayObject {
        constructor(value) {
            ...
            this.$renderNode = new dou2d.NormalBitmapNode();
        ...
        $updateRenderNode() {
            if (this._texture) {
                ...
                if (scale9Grid) {
                    if (this.$renderNode instanceof dou2d.NormalBitmapNode) {
                        this.$renderNode = new dou2d.BitmapNode();
                    }
                    dou2d.BitmapNode.updateTextureDataWithScale9Grid(this.$renderNode, this.$bitmapData, scale9Grid, this._bitmapX, this._bitmapY, this._bitmapWidth, this._bitmapHeight, this._offsetX, this._offsetY, this._textureWidth, this._textureHeight, destW, destH, this._sourceWidth, this._sourceHeight, this._smoothing);
                }
                else {
                    if (this.fillMode == "repeat" /* repeat */ && this.$renderNode instanceof dou2d.NormalBitmapNode) {
                        this.$renderNode = new dou2d.BitmapNode();
                    }
                    dou2d.NormalBitmapNode.updateTextureData(this.$renderNode, this.$bitmapData, this._bitmapX, this._bitmapY, this._bitmapWidth, this._bitmapHeight, this._offsetX, this._offsetY, this._textureWidth, this._textureHeight, destW, destH, this._sourceWidth, this._sourceHeight, this._fillMode, this._smoothing);
                }
            }
        }
        $hitTest(stageX, stageY) {
...
(function (dou2d) {
    ...
    class Graphics {
        constructor() {
            ...
            this._maxX = -Infinity;
            this._maxY = -Infinity;
            this._renderNode = new dou2d.GraphicsNode();
        }
        /**
         * 设置绑定到的目标显示对象
         */
...
(function (dou2d) {
    ...
    class Texture {
        ...
        $getScaleBitmapWidth() {
            return this.bitmapWidth * dou2d.textureScaleFactor;
        }
        /**
         * 纹理高度，只读属性，不可以设置
         */
        ...
        $getScaleBitmapHeight() {
            return this.bitmapHeight * dou2d.textureScaleFactor;
        }
        ...
        $setBitmapData(value) {
            ...
            let scale = dou2d.textureScaleFactor;
...
(function (dou2d) {
    ...
    class RenderTexture extends dou2d.Texture {
        constructor() {
            super();
            this.$renderBuffer = new dou2d.RenderBuffer();
        ...
        drawToTexture(displayObject, clipBounds, scale = 1) {
            ...
            scale /= dou2d.textureScaleFactor;
            ...
            dou2d.renderer.render(displayObject, renderBuffer, matrix);
            matrix.recycle();
            // 设置纹理参数
...
(function (dou2d) {
     ...
     * @author wizardc
     */
    class NormalBitmapNode extends dou2d.RenderNode {
        constructor() {
            super();
            /**
             * 控制在缩放时是否对位图进行平滑处理
    ...
    dou2d.NormalBitmapNode = NormalBitmapNode;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
     ...
     * @author wizardc
     */
    class BitmapNode extends dou2d.RenderNode {
        constructor() {
            super();
            /**
             * 控制在缩放时是否对位图进行平滑处理
        ...
        static updateTextureDataWithScale9Grid(node, image, scale9Grid, bitmapX, bitmapY, bitmapWidth, bitmapHeight, offsetX, offsetY, textureWidth, textureHeight, destW, destH, sourceWidth, sourceHeight, smoothing) {
            ...
            destW = destW - (textureWidth - bitmapWidth * dou2d.textureScaleFactor);
            destH = destH - (textureHeight - bitmapHeight * dou2d.textureScaleFactor);
            let targetW0 = scale9Grid.x - offsetX;
            let targetH0 = scale9Grid.y - offsetY;
            let sourceW0 = targetW0 / dou2d.textureScaleFactor;
            let sourceH0 = targetH0 / dou2d.textureScaleFactor;
            let sourceW1 = scale9Grid.width / dou2d.textureScaleFactor;
            let sourceH1 = scale9Grid.height / dou2d.textureScaleFactor;
            // 防止空心的情况出现
            if (sourceH1 == 0) {
                sourceH1 = 1;
            ...
            let targetW2 = sourceW2 * dou2d.textureScaleFactor;
            let targetH2 = sourceH2 * dou2d.textureScaleFactor;
            if ((sourceW0 + sourceW2) * dou2d.textureScaleFactor > destW || (sourceH0 + sourceH2) * dou2d.textureScaleFactor > destH) {
...
(function (dou2d) {
     ...
     * @author wizardc
     */
    class TextNode extends dou2d.RenderNode {
        constructor() {
            super();
    ...
    dou2d.TextNode = TextNode;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    dou2d.CAPS_STYLES = ["none", "round", "square"];
    dou2d.JOINT_STYLES = ["bevel", "miter", "round"];
    /**
     * 矢量渲染节点
     * @author wizardc
     */
    class GraphicsNode extends dou2d.RenderNode {
        constructor() {
            super();
            /**
             * 脏渲染标记
        ...
        beginGradientFill(type, colors, alphas, ratios, matrix, beforePath) {
            ...
            let path = new dou2d.GradientFillPath();
        ...
        lineStyle(thickness, color, alpha = 1, caps, joints, miterLimit = 3, lineDash = []) {
            if (dou2d.CAPS_STYLES.indexOf(caps) == -1) {
                caps = "round";
            }
            if (dou2d.JOINT_STYLES.indexOf(joints) == -1) {
                joints = "round";
            }
            let path = new dou2d.StrokePath();
    ...
    dou2d.GraphicsNode = GraphicsNode;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
     ...
     * @author wizardc
     */
    class GroupNode extends dou2d.RenderNode {
        constructor() {
            super();
...
(function (dou2d) {
     ...
     * @author wizardc
     */
    class FillPath extends dou2d.Path2D {
        constructor() {
            super();
            this._type = 1 /* fill */;
        }
    }
    dou2d.FillPath = FillPath;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
     ...
     * @author wizardc
     */
    class StrokePath extends dou2d.Path2D {
        constructor() {
            super();
            this._type = 3 /* stroke */;
        }
    }
    dou2d.StrokePath = StrokePath;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
     ...
     * @author wizardc
     */
    class GradientFillPath extends dou2d.Path2D {
        constructor() {
            super();
            this._type = 2 /* gradientFill */;
        }
    }
    dou2d.GradientFillPath = GradientFillPath;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class RenderBuffer {
        constructor(width, height, root) {
            ...
            this.context = dou2d.RenderContext.getInstance(width, height);
            // 创建渲染目标
            this.renderTarget = new dou2d.RenderTarget(this.context.context, 3, 3);
            if (width && height) {
    ...
    dou2d.RenderBuffer = RenderBuffer;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class RenderTarget {
         ...
         */
        createTexture() {
            const webglrendercontext = dou2d.RenderContext.getInstance();
    ...
    dou2d.RenderTarget = RenderTarget;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class RenderContext {
        constructor(width, height) {
            ...
            this.drawCommand = new dou2d.DrawCommand();
            this._vertexData = new dou2d.VertexData();
        ...
        getTexture(bitmapData) {
            if (!bitmapData.webGLTexture) {
                ...
                if (bitmapData.webGLTexture) {
                    bitmapData.webGLTexture[dou2d.SMOOTHING] = true;
                }
            }
        ...
        drawTexture(texture, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight, textureWidth, textureHeight, rotated, smoothing) {
            ...
            if (smoothing != undefined && texture[dou2d.SMOOTHING] != smoothing) {
                ...
                case 0 /* texture */:
                    if (filter) {
                        if (filter.type === "custom") {
                            program = dou2d.Program.getProgram(filter.$shaderKey, gl, filter.$vertexSrc, filter.$fragmentSrc);
                        }
                        else if (filter.type === "colorTransform") {
                            program = dou2d.Program.getProgram("colorTransform", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.colorTransform_fs);
                        }
                        else if (filter.type === "blurX") {
                            program = dou2d.Program.getProgram("blur", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.blur_fs);
                        }
                        else if (filter.type === "blurY") {
                            program = dou2d.Program.getProgram("blur", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.blur_fs);
                        }
                        else if (filter.type === "glow") {
                            program = dou2d.Program.getProgram("blur", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.glow_fs);
                        }
                    }
                    else {
                        program = dou2d.Program.getProgram("texture", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.texture_fs);
                    }
                    ...
                    break;
                case 1 /* rect */:
                    program = dou2d.Program.getProgram("primitive", gl, dou2d.ShaderLib.default_vs, dou2d.ShaderLib.primitive_fs);
                    this.activeProgram(gl, program);
                    this.syncUniforms(program, filter, data.textureWidth, data.textureHeight);
        ...
        drawTargetWidthFilters(filters, input) {
            ...
            if (filtersLen > 1) {
                for (let i = 0; i < filtersLen - 1; i++) {
                    ...
                    output = dou2d.RenderBuffer.get(width, height);
                    output.setTransform(1, 0, 0, 1, 0, 0);
                    output.globalAlpha = 1;
                    this.drawToRenderTarget(filter, input, output);
                    if (input != originInput) {
                        dou2d.RenderBuffer.put(input);
                    }
                    input = output;
                }
            }
        ...
        drawToRenderTarget(filter, input, output) {
            ...
            if (filter.type == "blur") {
                ...
                if (blurXFilter.blurX != 0 && blurYFilter.blurY != 0) {
                    temp = dou2d.RenderBuffer.get(width, height);
    ...
    dou2d.RenderContext = RenderContext;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class DrawCommand {
        ...
        pushChangeSmoothing(texture, smoothing) {
            texture[dou2d.SMOOTHING] = smoothing;
            let data = this.drawData[this.drawDataLen] || {};
...
(function (dou2d) {
    ...
    class VertexData {
        ...
        cacheArrays(buffer, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight, textureSourceWidth, textureSourceHeight, rotated) {
            ...
            if (alpha < 1.0 && currentTexture && currentTexture[dou2d.UNPACK_PREMULTIPLY_ALPHA_WEBGL]) {
...
(function (dou2d) {
    ...
    class DisplayList {
        ...
        static create(target) {
            ...
            try {
                let buffer = new dou2d.RenderBuffer();
                displayList.renderBuffer = buffer;
            }
            catch (e) {
                return null;
        ...
        drawToSurface() {
            ...
            buffer.clear();
            drawCalls = dou2d.renderer.render(this.root, buffer, this._offsetMatrix);
            // 对非舞台画布要保存渲染节点
            if (!this._isStage) {
...
(function (dou2d) {
    ...
    dou2d.CanvasRenderBuffer = CanvasRenderBuffer;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class CanvasRenderer {
        renderText(node, context) {
            ...
            while (pos < length) {
                ...
                context.fillStyle = dou2d.toColorString(textColor);
                context.strokeStyle = dou2d.toColorString(strokeColor);
                if (stroke) {
            ...
            for (let i = 0; i < length; i++) {
                ...
                switch (path.type) {
                    ...
                    case 3 /* stroke */:
                        ...
                        context.lineCap = dou2d.CAPS_STYLES[strokeFill.caps];
    ...
    dou2d.CanvasRenderer = CanvasRenderer;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    ...
    class Renderer {
        ...
        drawDisplayObject(displayObject, buffer, offsetX, offsetY, isStage) {
            ...
            if (displayList && !isStage) {
                if (displayObject.$cacheDirty || displayObject.$renderDirty ||
                    displayList.$canvasScaleX != dou2d.DisplayList.$canvasScaleX ||
                    displayList.$canvasScaleY != dou2d.DisplayList.$canvasScaleY) {
        ...
        renderText(node, buffer) {
            ...
            let canvasScaleX = dou2d.DisplayList.$canvasScaleX;
            let canvasScaleY = dou2d.DisplayList.$canvasScaleY;
            ...
            if (!this._canvasRenderBuffer || !this._canvasRenderBuffer.context) {
                this._canvasRenderer = new dou2d.CanvasRenderer();
                this._canvasRenderBuffer = new dou2d.CanvasRenderBuffer(width, height);
            }
        ...
        createRenderBuffer(width, height) {
            ...
            if (buffer) {
                ...
                buffer = new dou2d.RenderBuffer(width, height);
                buffer.computeDrawCall = false;
            }
            return buffer;
        }
    }
    dou2d.Renderer = Renderer;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
...
(function (dou2d) {
    ...
    })(ShaderLib = dou2d.ShaderLib || (dou2d.ShaderLib = {}));
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
    ...
    class Program {
        ...
        extractAttributes(gl, program) {
            ...
            for (let i = 0; i < totalAttributes; i++) {
                ...
                let attribute = new dou2d.Attribute(gl, program, attribData);
        ...
        extractUniforms(gl, program) {
            ...
            for (let i = 0; i < totalUniforms; i++) {
                ...
                let uniform = new dou2d.Uniform(gl, program, uniformData);
...
(function (dou2d) {
    ...
    (function (input) {
        ...
        class HtmlText extends dou.EventDispatcher {
            ...
            addToStage() {
                this._htmlInput = dou2d.inputManager;
            }
            show() {
            ...
            resetColor() {
                if (this._inputElement) {
                    this.setElementStyle("color", dou2d.toColorString(this._colorValue));
                }
            }
            onBlur() {
            }
            ...
            resetStageText() {
                if (this._inputElement) {
                    ...
                    this.setElementStyle("color", dou2d.toColorString(textfield.textColor));
                    let tw;
                    if (textfield.stage) {
    ...
    (function (input) {
        ...
        class InputManager {
            ...
            updateSize() {
                ...
                this.scaleX = dou2d.DisplayList.$canvasScaleX;
                this.scaleY = dou2d.DisplayList.$canvasScaleY;
...
(function (dou2d) {
    ...
    class TextField extends dou2d.DisplayObject {
        constructor() {
            ...
            let textNode = new dou2d.TextNode();
        ...
        $setStrokeColor(value) {
            ...
            if (values[25 /* strokeColor */] != value) {
                ...
                values[26 /* strokeColorString */] = dou2d.toColorString(value);
                return true;
            }
            return false;
        }
        ...
        fillBackground(lines) {
            ...
            if (values[33 /* background */] || values[31 /* border */] || (lines && lines.length > 0)) {
                if (!graphics) {
                    graphics = this._graphicsNode = new dou2d.GraphicsNode();
                    let groupNode = new dou2d.GroupNode();
...
(function (dou2d) {
    ...
    dou2d.$updateCallLater = $updateCallLater;
    /**
     * 注册一个下次渲染之前执行的方法
     */
...
(function (dou2d) {
    ...
    dou2d.$updateTimeout = $updateTimeout;
    /**
     * 添加超时计时器
     */
...
(function (dou2d) {
    ...
    dou2d.$updateInterval = $updateInterval;
    /**
     * 添加重复计时器
     */
...
(function (dou2d) {
    ...
    (function (HtmlUtil) {
        ...
        function measureText(text, fontFamily, fontSize, bold, italic) {
            ...
            dou2d.context2D.font = font;
            return measureTextWidth(dou2d.context2D, text);
        }
...
(function (dou2d) {
    ...
    (function (WebGLUtil) {
        function createTexture(renderContext, sourceOrWidth, height, data) {
            ...
            texture[dou2d.glContext] = gl;
            gl.bindTexture(gl.TEXTURE_2D, texture);
            gl.pixelStorei(gl.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1);
            texture[dou2d.UNPACK_PREMULTIPLY_ALPHA_WEBGL] = true;
        ...
        function deleteTexture(texture) {
            // 引擎默认的空白纹理不允许删除
            if (texture[dou2d.engine_default_empty_texture]) {
                if (DEBUG) {
                    console.warn("Can not delete WebGLTexture: " + dou2d.engine_default_empty_texture);
                }
                return;
            }
            let gl = texture[dou2d.glContext];
            if (gl) {
...
(function (dou2d) {
    ...
    dou2d.toColorString = toColorString;
})(dou2d || (dou2d = {}));
var dou2d;
(function (dou2d) {
    /**
...
(function (dou2d) {
    ...
    class Engine {
        ...
        init(rootClass, div, runOptions) {
            ...
            dou2d.stage = new dou2d.Stage(this);
            dou2d.screenAdapter = options.screenAdapter;
            dou2d.renderer = new dou2d.Renderer();
            let renderBuffer = new dou2d.RenderBuffer(undefined, undefined, true);
            dou2d.canvas = renderBuffer.surface;
            dou2d.context2D = dou2d.HtmlUtil.get2DContext(dou2d.HtmlUtil.createCanvas(2, 2));
            this._touchHandler = new dou2d.touch.TouchHandler(dou2d.stage, dou2d.canvas);
            this._input = new dou2d.input.InputManager();
            dou2d.player = new dou2d.Player(renderBuffer, dou2d.stage, options.rootClass);
            dou2d.player.start();
            dou2d.ticker = new dou2d.Ticker();
            this.startTicker();
            dou2d.stage.scaleMode = options.scaleMode;
            dou2d.stage.orientation = options.orientation;
            dou2d.stage.maxTouches = options.maxTouches;
            dou2d.stage.frameRate = options.frameRate;
            dou2d.stage.textureScaleFactor = options.textureScaleFactor;
            dou2d.stat = new dou2d.Stat();
        }
        readOptions(rootClass, runOptions) {
            ...
            return {
                ...
                textureScaleFactor: runOptions.canvasScaleFactor ? runOptions.canvasScaleFactor(dou2d.canvas.getContext("2d")) : 1
            };
        }
        startTicker() {
        ...
        updateScreenSize() {
            ...
            let orientation = dou2d.stage.orientation;
            ...
            let stageSize = dou2d.screenAdapter.calculateStageSize(dou2d.stage.scaleMode, screenWidth, screenHeight, option.contentWidth, option.contentHeight);
            ...
            let canvasScaleX = scalex * dou2d.DisplayList.$canvasScaleFactor;
            let canvasScaleY = scaley * dou2d.DisplayList.$canvasScaleFactor;
            let matrix = dou.recyclable(dou2d.Matrix);
            ...
            dou2d.DisplayList.$setCanvasScale(canvasScaleX, canvasScaleY);
            this._touchHandler.updateScaleMode(scalex, scaley, rotation);
            this._input.updateSize();
            dou2d.player.updateStageSize(stageWidth, stageHeight);
        }
