...
var examples;
(function (examples) {
    class ClipFilterTest extends dou2d.DisplayObjectContainer {
        constructor() {
            super();
        ...
        onAdded(event) {
            return __awaiter(this, void 0, void 0, function* () {
                let data = yield dou.loader.loadAsync("resource/img/wicker.jpg");
    ...
    examples.ClipFilterTest = ClipFilterTest;
})(examples || (examples = {}));
